...
<table class="easyui-datagrid" title="地址管理" style="height:auto" id="dgaddress"
    ...
    <tr>
        ...
        <th data-options="field:'name',width:180">收货人</th>
        <th data-options="field:'tel',width:200">电话</th>
        <th data-options="field:'post',width:60">邮政</th>
        <th data-options="field:'address',width:60">地址</th>
        <th data-options="field:'sendtime',width:100">发货时间</th>
        <th data-options="field:'issend',width:60">是否发送</th>
        <th data-options="field:'isdefault',width:60">是否签收</th>
...
<script src="<%=basePath%>/script/business/web/addressManage.js"></script>
