...
<form class="layui-form" id="ff">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input  name="password" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入测试的密码" class="layui-input" type="text" >
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">性别：</label>
        <div class="layui-input-block">
            <input name="sex" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入测试的性别" class="layui-input" type="text" >
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">年龄：</label>
        <div class="layui-input-block">
            <input  name="age" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入测试的年龄" class="layui-input" type="text" >
        </div>
